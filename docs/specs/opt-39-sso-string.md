# OPT-39 -- Small-String Optimized Container

## Overview
**Category:** String optimization
**Extension file:** `sso_string.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <6 MB | **Disk:** <1 MB

## Algorithm

len<=22: inline 23-byte buffer. Else: {ptr, len} heap. 60% fewer allocs for anchors. O(1) short.
