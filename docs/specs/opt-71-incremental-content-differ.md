# OPT-71 -- Incremental Content Differ

## Overview
**Category:** Pipeline optimization
**Extension file:** `incr_diff.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <5 MB | **Disk:** <1 MB

## Algorithm

Hash(content) per page. Skip if unchanged. Process only changed set. O(n) hash, O(delta) process.
