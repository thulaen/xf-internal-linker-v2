# OPT-54 -- Memory-Mapped Embeddings

## Overview
**Category:** I/O prefetch
**Extension file:** `mmap_embed.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <1 MB | **Disk:** <1 MB

## Algorithm

mmap(MAP_SHARED, PROT_READ). OS page-faults only accessed rows. MADV_SEQUENTIAL. O(1) open.
