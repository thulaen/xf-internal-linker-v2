# OPT-35 -- Struct-of-Arrays Layout

## Overview
**Category:** Cache-friendly layout
**Extension file:** `soa_candidate.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <10 MB | **Disk:** <1 MB

## Algorithm

Split {id,score,url,text} into arrays: float scores[N], int ids[N]. 2-3x faster filter/sort. O(n).
