# OPT-48 -- Work-Stealing Thread Pool

## Overview
**Category:** Parallel processing
**Extension file:** `worksteal_pool.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <5 MB | **Disk:** <1 MB

## Algorithm

Deque per thread. Steal from random victim when empty. task = std::function<void()>. O(1) push/steal.
