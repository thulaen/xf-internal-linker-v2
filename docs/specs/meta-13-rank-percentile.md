# META-13-RANK-PERCENTILE — Rank Percentile Normalizer

## Overview
**Category:** Score normalizer
**Extension file:** `rank_pctl.cpp`
**Replaces/improves:** Python rank/n
**Expected speedup:** ≥5x over numpy
**RAM:** <1 MB | **Disk:** <1 MB

## Algorithm

pᵢ = (rank(sᵢ) - 0.5) / n. Produces uniform [0,1]. Van der Waerden scores for normal approximation: Φ⁻¹(pᵢ). O(n log n).
...
## Test Plan
- n=1: output 0.5
- Sorted input: output evenly spaced
- Ties: average rank
