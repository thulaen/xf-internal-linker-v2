# META-10-SIGMOID-TEMPERATURE — Sigmoid Temperature Scaler

## Overview
**Category:** Score normalizer
**Extension file:** `sigmoid_temp.cpp`
**Replaces/improves:** Python sigmoid function
**Expected speedup:** ≥5x over numpy
**RAM:** <1 MB | **Disk:** <1 MB

## Algorithm

f(s) = 1/(1+exp(-(s-μ)/τ)). Learn μ (shift) and τ (temperature) per signal by MLE on click labels. O(n) per signal.
...
## Test Plan
- τ=1, μ=0: standard sigmoid
- τ→0: step function at μ
