# OPT-19 -- Sparse Bit Vector

## Overview
**Category:** Data structure
**Extension file:** `sparse_bitvec.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <1 MB | **Disk:** <1 MB

## Algorithm

Dense for dense regions. Sparse hash for <10% fill. Rank via popcount prefix sum. 90% less when sparse.
