# META-09-QUANTILE-NORMALIZER — Quantile Score Normalizer

## Overview
**Category:** Score normalizer
**Extension file:** `quantile_norm.cpp`
**Replaces/improves:** Python rank + divide
**Expected speedup:** ≥5x over numpy argsort
**RAM:** <1 MB | **Disk:** <1 MB

## Algorithm

q̂ᵢ = rank(sᵢ among {s₁..sₙ}) / n. Output q̂ᵢ ∈ (0,1] per candidate per signal. O(n log n) for sort.
...
## Test Plan
- All equal scores: all output 0.5
- Already sorted: output matches manual rank computation
- n=1: output 1.0
