# OPT-44 -- FlatBuffers Zero-Copy

## Overview
**Category:** Serialization
**Extension file:** `flatvec.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <2 MB | **Disk:** <1 MB

## Algorithm

table Embedding {dims:uint16; data:[float32]}. Zero-copy access via offset. 10x faster than pickle. O(1) access.
