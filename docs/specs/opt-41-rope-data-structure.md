# OPT-41 -- Rope Data Structure

## Overview
**Category:** String optimization
**Extension file:** `rope_text.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <4 MB | **Disk:** <1 MB

## Algorithm

Binary tree of chunks. concat = new node(left,right) O(1). Iterate leaves for full string. O(log n) index.
