# OPT-40 -- String Interning Table

## Overview
**Category:** String optimization
**Extension file:** `str_intern.cpp`
**Expected speedup:** >=3x over Python equivalent
**RAM:** <10 MB | **Disk:** <1 MB

## Algorithm

Global hash map: string -> canonical pointer. intern(s) = find or insert. Compare by pointer. 30-50% less. O(1) avg.
