...
def test_bench_scoring_full_batch_small(benchmark):
    ...
    benchmark(scoring.calculate_composite_scores_full_batch,
              components, weights, silo)
...
def test_bench_simsearch_small(benchmark, query_embedding):
    ...
    benchmark(simsearch.score_and_topk,
              query_embedding, sentences, candidates, 50)
