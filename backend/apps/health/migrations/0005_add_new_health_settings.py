...
def add_health_settings(apps, schema_editor):
    ...
    settings = [
        (
            ...
            "int",
            "performance",
            "Warn if pipeline run failure rate exceeds this % (7-day window)",
        ),
        (
            ...
            "int",
            "performance",
            "Warn if no pipeline run has started in this many hours",
        ),
        (
            ...
            "int",
            "performance",
            "Warn if any Celery queue has more than this many pending tasks",
        ),
        (
            ...
            "int",
            "performance",
            "Error if any Celery queue exceeds this many pending tasks",
        ),
        (
            ...
            "int",
            "performance",
            "Warn if Celery Beat last fired more than this many minutes ago",
        ),
        (
        ...
        (
            ...
            "int",
            "performance",
            "Error if disk usage exceeds this percentage",
        ),
    ]
