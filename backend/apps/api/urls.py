...
from apps.api.embedding_views import (
    ...
    embedding_provider,
    embedding_provider_eval_run,
    embedding_provider_eval_runs,
    embedding_provider_unban,
    embedding_settings,
    embedding_status,
...
urlpatterns = [
    ...
    path(
        "schedules/<str:task_name>/run-now/", schedule_run_now, name="schedule-run-now"
    ),
    path("reports/monthly/", monthly_reports_list, name="monthly-reports-list"),
    path(
        "reports/monthly/<str:month>/", monthly_report_read, name="monthly-report-read"
    ),
    ...
    path(
        "diagnostics/accuracy/tools/",
        AccuracyToolsView.as_view(),
        name="diagnostics-accuracy-tools",
    ),
    path(
        "diagnostics/accuracy/summary/",
        AccuracySummaryView.as_view(),
        name="diagnostics-accuracy-summary",
    ),
    path(
        "diagnostics/accuracy/findings/",
        AccuracyFindingsView.as_view(),
        name="diagnostics-accuracy-findings",
    ),
    path(
        "diagnostics/accuracy/report/",
        AccuracyReportView.as_view(),
        name="diagnostics-accuracy-report",
    ),
    path(
        "diagnostics/accuracy/run/",
        AccuracyRunView.as_view(),
        name="diagnostics-accuracy-run",
    ),
    ...
    path(
        "embedding/provider-evaluations/",
        embedding_provider_eval_runs,
        name="embedding-provider-eval-runs",
    ),
    path(
        "embedding/provider-evaluations/run/",
        embedding_provider_eval_run,
        name="embedding-provider-eval-run",
    ),
    path("embedding/provider/unban/", embedding_provider_unban, name="embedding-provider-unban"),
