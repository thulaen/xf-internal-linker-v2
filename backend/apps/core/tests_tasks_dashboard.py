...
class TestRefreshDashboardMatviews(SimpleTestCase):
    ...
    def test_when_not_in_atomic_block_then_connection_closed(self, mock_connection):
        ...
        with patch("apps.core.tasks_dashboard.refresh_suggestion_counts_matview", create=True) as mock_refresh:
    ...
    @patch("apps.core.tasks_dashboard.connection")
    @patch("apps.core.tasks_dashboard.refresh_suggestion_counts_matview", create=True)
