...
SIGNALS: list[SignalDefinition] = [
    SignalDefinition(
        id="nk_link_prediction",
        name="NetworKit Link Prediction",
        type="ranking",
        description="Structural link prediction candidates (Adamic-Adar, Jaccard, Common Neighbors).",
        table_name="graph_linkpredictioncandidate",
        weight_key="graph.nk_link_prediction.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Liben-Nowell & Kleinberg 2007",
        source_kind="paper",
    ...
    SignalDefinition(
        id="nk_communities",
        name="NetworKit Communities",
        type="ranking",
        description="Community detection Louvain signals (same community, bridge).",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_communities.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Blondel et al. 2008",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_betweenness",
        name="NetworKit Betweenness",
        type="ranking",
        description="Betweenness centrality and structural holes.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_betweenness.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Brandes 2001",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_reach",
        name="NetworKit Reach",
        type="ranking",
        description="Reach and click-depth signals.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_reach.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Graph traversal",
    ...
    SignalDefinition(
        id="nk_centrality",
        name="NetworKit Centrality Panel",
        type="ranking",
        description="Eigenvector, Katz, and closeness centrality.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_centrality.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Bonacich 1972",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_kcore",
        name="NetworKit k-core",
        type="ranking",
        description="k-core decomposition shell number.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_kcore.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Seidman 1983",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        ...
        type="ranking",
        description="Weakly connected component and main component signals.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_components.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Graph Connectivity",
        source_kind="heuristic",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_local_clustering",
        name="NetworKit Local Clustering",
        type="ranking",
        description="Local clustering coefficient.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_local_clustering.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Network properties",
        source_kind="heuristic",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_node2vec",
        name="NetworKit node2vec",
        type="ranking",
        description="Structural embedding vector cosine similarity.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_node2vec.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Grover & Leskovec 2016",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="nk_group_seed_rank",
        name="NetworKit Group Seed Rank",
        type="ranking",
        description="Rank order as a group-closeness seed.",
        table_name="graph_nodegraphsignal",
        weight_key="graph.nk_group_seed_rank.ranking_weight",
        status="active",
        fr_id="fr-networkit-graph-signals",
        spec_path="docs/specs/fr-networkit-graph-signals.md",
        academic_source="Group closeness",
        source_kind="heuristic",
        architecture_lane="python_only",
        neutral_value=0.5,
        diagnostic_surfaces=("suggestion_detail", "weight_diagnostics"),
    ...
    SignalDefinition(
        id="darb",
        name="Dangling Authority Redistribution Bonus",
        type="ranking",
        description="FR-099: boost for high-value host pages with very few outbound internal links.",
        table_name="suggestions_suggestion (score_darb)",
        cpp_kernel=None,
        weight_key="darb.ranking_weight",
        fr_id="FR-099",
        spec_path="docs/specs/fr099-dangling-authority-redistribution-bonus.md",
        academic_source="Page et al. 1999 - The PageRank Citation Ranking, Stanford InfoLab 1999-66 §2.5 and §3.2 eq. 1",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 host ContentItem with content-value score and outgoing-link count",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ),
        benchmark_module="backend/benchmarks/test_bench_fr099_fr105_signals.py",
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39a",
    ),
    SignalDefinition(
        id="kmig",
        name="Katz Marginal Information Gain",
        type="ranking",
        description="FR-100: bonus for candidate links that add graph reachability not already present within one or two hops.",
        table_name="suggestions_suggestion (score_kmig)",
        cpp_kernel=None,
        weight_key="kmig.ranking_weight",
        fr_id="FR-100",
        spec_path="docs/specs/fr100-katz-marginal-information-gain.md",
        academic_source="Katz 1953, Psychometrika 18(1):39-43, DOI 10.1007/BF02289026 §2 eq. 2",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 cached internal-link graph with host and destination nodes",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ...
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39b",
    ),
    SignalDefinition(
        id="tapb",
        name="Tarjan Articulation Point Boost",
        type="ranking",
        description="FR-101: boost when the host page is a graph bridge point that keeps site sections connected.",
        table_name="suggestions_suggestion (score_tapb)",
        cpp_kernel=None,
        weight_key="tapb.ranking_weight",
        fr_id="FR-101",
        spec_path="docs/specs/fr101-tarjan-articulation-point-boost.md",
        academic_source="Tarjan 1972, SIAM Journal on Computing 1(2):146-160, DOI 10.1137/0201010 §3",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 cached graph with enough nodes to identify articulation points",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ...
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39c",
    ),
    SignalDefinition(
        id="kcib",
        name="K-Core Integration Boost",
        type="ranking",
        description="FR-102: boost for links that integrate peripheral pages with dense graph-core pages.",
        table_name="suggestions_suggestion (score_kcib)",
        cpp_kernel=None,
        weight_key="kcib.ranking_weight",
        fr_id="FR-102",
        spec_path="docs/specs/fr102-kcore-integration-boost.md",
        academic_source="Seidman 1983, Social Networks 5(3):269-287, DOI 10.1016/0378-8733(83)90028-X §2 eq. 1",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 cached graph with host and destination k-core values",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ...
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39d",
    ),
    SignalDefinition(
        id="berp",
        name="Bridge-Edge Redundancy Penalty",
        type="ranking",
        description="FR-103: small penalty when a suggested edge would create a fragile bridge between components.",
        table_name="suggestions_suggestion (score_berp)",
        cpp_kernel=None,
        weight_key="berp.ranking_weight",
        fr_id="FR-103",
        spec_path="docs/specs/fr103-bridge-edge-redundancy-penalty.md",
        academic_source="Hopcroft and Tarjan 1973, Communications of the ACM 16(6):372-378, DOI 10.1145/362248.362272 §2 Algorithm 3",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 cached graph with biconnected-component labels",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ...
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39e",
    ),
    SignalDefinition(
        id="hgte",
        name="Host-Graph Topic Entropy Boost",
        type="ranking",
        description="FR-104: boost when a candidate diversifies the host page's outbound topic mix.",
        table_name="suggestions_suggestion (score_hgte)",
        cpp_kernel=None,
        weight_key="hgte.ranking_weight",
        fr_id="FR-104",
        spec_path="docs/specs/fr104-host-graph-topic-entropy-boost.md",
        academic_source="Shannon 1948, Bell System Technical Journal 27(3):379-423, DOI 10.1002/j.1538-7305.1948.tb01338.x §6 eq. 4",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 host outbound-link silo distribution and destination silo",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
        ...
        autotune_included=True,
        default_enabled=True,
        added_in_phase="Phase 39f",
    ),
    SignalDefinition(
        id="rsqva",
        name="Reverse Search-Query Vocabulary Alignment",
        type="ranking",
        description="FR-105: TF-IDF vocabulary alignment between host and destination Google Search Console queries.",
        table_name="suggestions_suggestion (score_rsqva)",
        cpp_kernel=None,
        weight_key="rsqva.ranking_weight",
        fr_id="FR-105",
        spec_path="docs/specs/fr105-reverse-search-query-vocabulary-alignment.md",
        academic_source="Salton and Buckley 1988, Information Processing & Management 24(5):513-523, DOI 10.1016/0306-4573(88)90021-0 §3-4",
        source_kind="paper",
        architecture_lane="python_only",
        neutral_value=0.0,
        min_data_threshold=">=1 host and destination query-vector row from Search Console data",
        diagnostic_surfaces=(
            "suggestion_detail",
            "weight_diagnostics",
            "system_health",
