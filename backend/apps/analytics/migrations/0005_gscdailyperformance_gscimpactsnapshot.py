        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The GSC property this belongs to.",
                        max_length=500,
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["date", "page_url"], name="analytics_g_date_5559de_idx"
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        default=0.0,
                        help_text="Relative click lift: (post - baseline) / baseline.",
                    ),
                ),
                ...
                (
                    ...
                    models.FloatField(
                        default=0.0,
                        help_text="Bayesian probability of positive lift (0.0 to 1.0).",
                    ),
                ),
                (
                    "reward_label",
