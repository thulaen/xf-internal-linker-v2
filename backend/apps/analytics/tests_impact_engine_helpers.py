...
class TestBayesianTrendAttributorComputeUplift(SimpleTestCase):
    ...
    def test_positive_reward_when_clicks_jump(self):
        ...
        result = self.attr.compute_uplift(
            target_clicks_base=10,
            target_imps_base=1000,
            target_clicks_post=100,
            target_imps_post=1000,
            control_clicks_base=10,
            control_imps_base=1000,
            control_clicks_post=10,
            control_imps_post=1000,
        )
    ...
    def test_negative_reward_when_clicks_drop(self):
        np.random.seed(_SEED)
        result = self.attr.compute_uplift(
            target_clicks_base=100,
            target_imps_base=1000,
            target_clicks_post=10,
            target_imps_post=1000,
            control_clicks_base=100,
            control_imps_base=1000,
            control_clicks_post=100,
            control_imps_post=1000,
        )
    ...
    def test_inconclusive_with_few_clicks(self):
        np.random.seed(_SEED)
        result = self.attr.compute_uplift(
            target_clicks_base=1,
            target_imps_base=10,
            target_clicks_post=1,
            target_imps_post=10,
            control_clicks_base=1,
            control_imps_base=10,
            control_clicks_post=1,
            control_imps_post=10,
        )
    ...
    def test_result_keys_present(self):
        ...
        result = self.attr.compute_uplift(
            target_clicks_base=10,
            target_imps_base=100,
            target_clicks_post=15,
            target_imps_post=100,
            control_clicks_base=10,
            control_imps_base=100,
            control_clicks_post=10,
            control_imps_post=100,
        )
        for key in (
