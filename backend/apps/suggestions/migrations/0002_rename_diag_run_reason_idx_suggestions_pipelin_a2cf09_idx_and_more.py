    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                auto_now_add=True, help_text="When this diagnostic record was created."
            ),
        ),
        migrations.AlterField(
            model_name="pipelinediagnostic",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                default=0, help_text="Number of destination items fully processed."
            ),
        ),
        migrations.AlterField(
            model_name="pipelinerun",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    (
                        "skip_pending",
                        "Skip Pending — don't replace existing pending suggestions",
                    ),
                    (
                        "supersede_pending",
                        "Supersede Pending — replace with new suggestions",
                    ),
                    (
                        "full_regenerate",
                        "Full Regenerate — replace all, including approved",
                    ),
                ],
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                default=0, help_text="Number of new suggestions generated in this run."
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="reviewer_notes",
            field=models.TextField(
                blank=True, help_text="Free-text notes from the reviewer."
            ),
        ),
        migrations.AlterField(
            model_name="suggestion",
        ...
        migrations.AlterField(
            ...
            name="superseded_at",
            field=models.DateTimeField(
                blank=True, help_text="When this suggestion was superseded.", null=True
            ),
        ),
        migrations.AlterField(
            model_name="suggestion",
