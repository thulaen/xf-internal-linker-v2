...
def upsert_expansion_slots(apps, schema_editor):
    ...
    specific_prefixes = [
        "newton", "lbfgs", "conjugate_gradient", "lbfgs_b", "simulated_annealing",
        "genetic_opt", "differential_evolution", "pso", "nelder_mead", "cma_es",
        "ranknet", "lambdarank", "lambdamart", "listnet", "rankboost", "tpe",
        "coordinate_ascent", "boltzmann_ranker", "softrank", "svm_rank",
        "glove", "fasttext_embeddings", "elmo", "bert", "roberta", "albert",
        "distilbert", "t5", "gpt2", "clip",
        "hits_hubs", "salsa", "eigentrust", "simrank", "pathsim", "deepwalk",
        "graphsage", "lambdaloss", "gcn", "gat",
        "isotonic_calibration", "temperature_scaling", "dirichlet_calibration",
        "beta_calibration", "venn_abers", "mc_dropout", "deep_ensembles",
        "platt_scaling", "conformal_inductive", "conformal_transductive",
        "weight_decay", "cosine_annealing", "lasso", "elastic_net", "batch_norm",
        "layer_norm", "swa", "label_smoothing", "dropconnect", "early_stopping",
        "smote", "adasyn", "ohem", "reservoir_sampling", "importance_sampling",
        "stratified_sampling", "downsampling", "bagging", "boosting", "cross_validation",
        "demographic_parity", "equalized_odds", "disparate_impact",
        "counterfactual_fairness", "individual_fairness", "group_fairness",
        "group_calibration", "rejection_option", "fair_preproc", "adversarial_debiasing"
    ]
