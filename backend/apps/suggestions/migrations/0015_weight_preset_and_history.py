        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="Flat key/value map of AppSetting keys → values for all settings in categories ml, link_freshness, and anchor.",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.CharField(
                        max_length=500, help_text="Plain-English summary."
                    ),
                ),
                (
                    "r_run_id",
