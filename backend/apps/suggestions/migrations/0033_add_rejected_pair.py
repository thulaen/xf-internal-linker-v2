        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        db_index=True,
                        help_text="When this pair was most recently rejected. Drives the suppression window during candidate generation.",
                    ),
                ),
                (
                    "rejection_count",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-last_rejected_at"],
                        name="suggestions_last_re_28d662_idx",
                    )
                ],
                "constraints": [
