...
The dict returned by ``get_forward_declared_weights()`` is merged into
...
def get_forward_declared_weights() -> dict[str, str]:
    """Return all forward-declared FR keys (FR-038 onward)."""
    return {
