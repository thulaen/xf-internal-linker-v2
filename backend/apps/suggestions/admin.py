...
class SuggestionAdmin(ModelAdmin):
    ...
    readonly_fields = [
        ...
        "score_march_2026_pagerank", "score_velocity", "score_link_freshness", "score_final",
    ...
    fieldsets = (
        ...
        ("Score Breakdown", {
            "fields": ("score_semantic", "score_keyword", "score_node_affinity",
                       "score_quality", "score_march_2026_pagerank", "score_velocity", "score_link_freshness", "score_final"),
            "classes": ("collapse",),
        }),
        ("Review", {
