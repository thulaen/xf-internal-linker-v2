...
class ContentItemAdmin(ModelAdmin):
    ...
    list_display = [
        ...
        "velocity_score", "link_freshness_score", "content_value_score", "view_count", "reply_count", "post_date",
        "is_deleted",
    ]
    ...
    readonly_fields = [
        ...
        "march_2026_pagerank_score", "velocity_score", "link_freshness_score", "content_value_score",
        "created_at", "updated_at", "fetched_at",
    ]
    list_per_page = 50
    ordering = ["-march_2026_pagerank_score"]
    inlines = [PostInline]
    ...
    fieldsets = (
        ...
        ("Scores", {
            "fields": ("march_2026_pagerank_score", "velocity_score", "link_freshness_score", "content_value_score"),
            "classes": ("collapse",),
        }),
        ("Engagement", {
