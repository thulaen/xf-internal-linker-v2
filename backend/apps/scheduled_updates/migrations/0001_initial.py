        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Set automatically when the job's next successful run completes. Resolved alerts drop out of the active list and are pruned after 30 days by jobalert_dedup_cleanup.",
                        null=True,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["acknowledged_at", "resolved_at"],
                        name="scheduled_u_acknowl_f5dd12_idx",
                    ),
                    models.Index(
                        fields=["job_key", "alert_type"],
                        name="scheduled_u_job_key_679d16_idx",
                    ),
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        help_text="Stable identifier for this job, e.g. 'pagerank_refresh' or 'lda_topic_refresh'. Code looks the job up by this key.",
                        max_length=128,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_index=True,
                        help_text="When the job's next run is planned. The runner uses this plus the priority to decide what to start next. Null = on-demand only.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.IntegerField(
                        default=86400,
                        help_text="Expected gap between successful runs. The catch-up detector flags the job as missed when now - last_success_at exceeds this.",
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="scheduled_u_state_9f7d3f_idx",
                    ),
                    models.Index(
                        fields=["scheduled_for"], name="scheduled_u_schedul_85fee0_idx"
                    ),
                    models.Index(
                        fields=["last_success_at"],
                        name="scheduled_u_last_su_3a66f9_idx",
                    ),
                ],
            },
        ),
