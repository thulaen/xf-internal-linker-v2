    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True, help_text="Full Python traceback (for debugging)."
            ),
        ),
        migrations.AlterField(
            model_name="errorlog",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                default=0, help_text="Number of suggestions approved."
            ),
        ),
        migrations.AlterField(
            model_name="reviewerscorecard",
        ...
        migrations.AlterField(
            ...
            name="rejected_count",
            field=models.IntegerField(
                default=0, help_text="Number of suggestions rejected."
            ),
        ),
        migrations.AlterField(
            model_name="reviewerscorecard",
        ...
        migrations.AlterField(
            ...
            name="total_reviewed",
            field=models.IntegerField(
                default=0, help_text="Total suggestions reviewed in this period."
            ),
        ),
        migrations.AlterField(
            model_name="reviewerscorecard",
        ...
        migrations.AddIndex(
            model_name="auditentry",
            index=models.Index(
                fields=["action", "-created_at"], name="audit_audit_action_d97ede_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="errorlog",
            index=models.Index(
                ...
                name="audit_error_acknowl_686e89_idx",
            ),
        ),
    ]
