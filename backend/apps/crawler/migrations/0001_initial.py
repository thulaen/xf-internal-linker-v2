...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="Crawl settings frozen at start: rate_limit, max_depth, max_pages, excluded_paths, timeout_hours.",
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Pages whose content differed from last crawl.",
                    ),
                ),
                (
                    "pages_skipped_304",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="Pages found that had no prior crawl record.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "discovery_method",
                    models.CharField(
                        choices=[("manual", "Manual"), ("auto", "Auto-discovered")],
                        default="manual",
                        max_length=20,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Disabled sitemaps are skipped during crawl.",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        db_index=True,
                        help_text="Canonical URL of the page.",
                        max_length=2000,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="True if <meta name='viewport'> is present.",
                    ),
                ),
                (
                    "h1_text",
                    models.CharField(
                        blank=True,
                        help_text="Text of the first <h1> tag.",
                        max_length=500,
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="crawler_sys_timesta_3651cb_idx",
                    ),
                    models.Index(
                        fields=["source", "-timestamp"],
                        name="crawler_sys_source_f27751_idx",
                    ),
                ],
            },
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["session", "http_status"], name="crawler_cra_session_48cb30_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="crawledpagemeta",
            index=models.Index(
                fields=["word_count"], name="crawler_cra_word_co_df9a85_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="crawledpagemeta",
            index=models.Index(
                fields=["consecutive_404_count"], name="crawler_cra_consecu_7066fb_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="crawledpagemeta",
            constraint=models.UniqueConstraint(
                fields=("session", "normalized_url"), name="unique_page_per_session"
            ),
        ),
    ]
