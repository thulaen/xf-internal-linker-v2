...
bool starts_with_ci(const std::string &text, size_t index,
...
size_t find_ci(const std::string &text, const std::string &needle,
               size_t start) {
...
bool span_overlaps(int start, int end,
