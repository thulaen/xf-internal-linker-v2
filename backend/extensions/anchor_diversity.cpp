...
void evaluate_anchor_diversity_core(const int32_t* active_anchor_counts,
                                    ...
                                    double* out_projected_exact_share, double* out_share_overflow,
                                    double* out_count_overflow_norm, double* out_spam_risk,
                                    double* out_score_anchor_diversity, int32_t* out_state_index,
...
py::dict evaluate_batch(
    ...
    int32_t min_history_count, double max_exact_match_share, int32_t max_exact_match_count,
...

    {
        ...
        evaluate_anchor_diversity_core(
            ...
            static_cast<double*>(spam_risk_buf.ptr), static_cast<double*>(score_out_buf.ptr),
            static_cast<int32_t*>(state_index_buf.ptr), static_cast<uint8_t*>(would_block_buf.ptr));
    }
