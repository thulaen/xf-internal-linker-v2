...
#ifndef XF_BENCH_MODE
py::array_t<float> score_full_batch(py::array_t<float> component_scores, py::array_t<float> weights,
    ...
    cscore_full_batch(static_cast<const float*>(c_info.ptr), num_rows, num_components,
