...
$baselineLongFiles = @(
    ...
    'diagnostics.component.ts', # pre-existing 798+ lines before Phase 1v — 6 forkJoin streams + realtime + error-log poll + error rerun + runtime-lane + execution-card builders; candidate for per-surface helper extraction
