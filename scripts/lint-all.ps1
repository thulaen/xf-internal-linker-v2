...
$n1PyFiles = @($n1PyFiles | Where-Object { $_ -notmatch '\\tests|\\migrations\\|impact_engine\.py$|\\sync\.py$|\\cooccurrence\\services\.py$|\\analytics\\tasks\.py$' })
