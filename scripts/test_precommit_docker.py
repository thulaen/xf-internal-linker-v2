...
def test_hard_gates_run_before_language_quality() -> None:
    ...
    first_quality = min(
        text.index("run_soft_gate run-angular-quality bash scripts/run-angular-quality.sh"),
        text.index("run_hard_gate run-python-quality bash scripts/run-python-quality.sh"),
    )
    hard_gates = (
