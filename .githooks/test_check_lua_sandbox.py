...
_MOD_PATH = Path(__file__).resolve().parent / "check-lua-sandbox.py"
_spec = importlib.util.spec_from_file_location("check_lua_sandbox", _MOD_PATH)
mod = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(mod)

class CheckLuaSandboxTests(unittest.TestCase):
