...
def main() -> int:
    ...
    if not summary:
        sys.stderr.write(
            ...
            "<none|low|medium|high|critical>`, then paste each printed "
            "marker (LOGGED or DEDUPED) plus the final summary line into "
            "the AGENT-HANDOFF.md entry.\n"
        )
        return 2
