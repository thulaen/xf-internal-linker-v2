...
@Component({
  ...
  imports: [MatCardModule, MatChipsModule, MatExpansionModule, MatIconModule, MatTooltipModule],
  template: `
      ...
      <mat-card-header>
        ...
        <mat-card-subtitle>
          ...
          <a
            ...
            matTooltip="See docs/PERFORMANCE.md in the repo"
        ...
        <ul class="policy-rules">
          <li>
            ...
            <span class="rule-text">
              <strong>Max one at a time.</strong> Heavy tasks (peak memory &gt; 1 GB) run one-by-one on the
              <code>pipeline</code> queue. Heavy jobs wait while another heavy job is running — this prevents
              out-of-memory kills.
            </span>
          </li>
          <li>
            ...
            <span class="rule-text">
              <strong>Max one at a time.</strong> Medium tasks (200 MB – 1 GB peak) share the same FIFO lock as Heavy
              but release faster.
            </span>
          </li>
          <li>
            ...
            <span class="rule-text">
              <strong>Unlimited parallel.</strong> Light tasks (under 200 MB) run on the <code>default</code> queue with
              no lock. Heartbeats, cleanups, and small tallies fall here.
            </span>
          </li>
          ...
          <li>
            ...
            <span class="rule-text">
              <strong>Afternoon window 13:00 – 15:00 UTC</strong> is reserved for Heavy and Medium jobs so they actually
              run on a laptop that's off overnight.
            </span>
          </li>
          <li>
            <mat-icon class="rule-icon">hourglass_bottom</mat-icon>
            <span class="rule-text">
              <strong>30-second stagger</strong> between consecutive Heavy tasks on worker startup keeps the catch-up
              system from spiking memory at once.
            </span>
          </li>
          <li>
            <mat-icon class="rule-icon">thermostat</mat-icon>
            <span class="rule-text">
              <strong>76 °C GPU ceiling.</strong> Any GPU task auto-pauses at 76 °C and only resumes below 68 °C. See
              Performance Mode for the current cap.
            </span>
          </li>
        </ul>
        ...
        <mat-accordion class="examples-accordion">
          <mat-expansion-panel class="examples-panel">
            ...
            <dl class="class-list">
              ...
              <dd>
                nightly-data-retention, cleanup-stuck-sync-jobs, nightly-benchmarks, pulse-heartbeat, watchdog-check,
                refresh-faiss-index, auto-prune, plus five smaller housekeeping jobs.
              </dd>
            </dl>
          </mat-expansion-panel>
        </mat-accordion>
