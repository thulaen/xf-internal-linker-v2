      ...
      <mat-stepper [linear]="false" #stepper>
        ...
        <mat-step label="Welcome">
          <div class="wizard-step">
            <p class="wizard-lead">This app finds smart places to add internal links across your forum or blog.</p>
        ...
        <mat-step label="Ready">
          <div class="wizard-step">
            ...
            <p>
              After connecting, head to <strong>Jobs</strong> to import your content, then come back to the
              <strong>Dashboard</strong> to run the pipeline.
            </p>
            <div class="wizard-actions">
              <button mat-button matStepperPrevious>Back</button>
