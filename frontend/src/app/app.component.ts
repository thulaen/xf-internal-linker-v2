...
export class AppComponent implements OnInit {
  ...
  navSections: NavSection[] = [
    {
      label: $localize`:@@nav.section.main:Main`,
      items: [
        {
          label: $localize`:@@nav.dashboard.label:Dashboard`,
          icon: 'dashboard',
          route: '/dashboard',
          tooltip: $localize`:@@nav.dashboard.tooltip:Overview of jobs, suggestions, and key metrics`,
        },
      ],
    },
    {
      label: $localize`:@@nav.section.analysis:Analysis`,
      items: [
        {
          label: $localize`:@@nav.review.label:Review`,
          icon: 'rate_review',
          route: '/review',
          tooltip: $localize`:@@nav.review.tooltip:Review and approve link suggestions`,
        },
        {
          label: $localize`:@@nav.linkHealth.label:Link Health`,
          icon: 'link_off',
          route: '/link-health',
          tooltip: $localize`:@@nav.linkHealth.tooltip:Broken link scanner and status tracker`,
        },
        {
          label: $localize`:@@nav.linkGraph.label:Link Graph`,
          icon: 'account_tree',
          route: '/graph',
          tooltip: $localize`:@@nav.linkGraph.tooltip:Visualize the internal link graph`,
        },
        {
          label: $localize`:@@nav.behavioralHubs.label:Behavioral Hubs`,
          icon: 'hub',
          route: '/behavioral-hubs',
          tooltip: $localize`:@@nav.behavioralHubs.tooltip:Co-navigation article clusters from GA4 session data`,
        },
        {
          label: $localize`:@@nav.analytics.label:Analytics`,
          icon: 'bar_chart',
          route: '/analytics',
          tooltip: $localize`:@@nav.analytics.tooltip:SEO impact reports from GSC and GA4`,
        },
        {
          label: $localize`:@@nav.embeddings.label:Embeddings`,
          icon: 'compare_arrows',
          route: '/embeddings',
          tooltip: $localize`:@@nav.embeddings.tooltip:Switch providers, run bake-offs, audit embedding quality`,
        },
      ],
    },
    {
      label: $localize`:@@nav.section.system:System`,
      items: [
        {
          label: $localize`:@@nav.jobs.label:Jobs`,
          icon: 'pending_actions',
          route: '/jobs',
          tooltip: $localize`:@@nav.jobs.tooltip:Background job queue and history`,
        },
        {
          label: $localize`:@@nav.systemHealth.label:System Health`,
          icon: 'health_and_safety',
          route: '/health',
          tooltip: $localize`:@@nav.systemHealth.tooltip:Real-time status of data sources and services`,
        },
        {
          label: $localize`:@@nav.aiAgents.label:AI Agents`,
          icon: 'extension',
          route: '/mcp',
          tooltip: $localize`:@@nav.aiAgents.tooltip:Connect Claude Code, Codex, and Antigravity to this app via MCP (the standard way modern AI agents call external tools). See live status and recent errors.`,
        },
        {
          label: $localize`:@@nav.monthlyReports.label:Monthly Reports`,
          icon: 'event_note',
          route: '/reports/monthly',
          tooltip: $localize`:@@nav.monthlyReports.tooltip:Top-50 link suggestions auto-generated on the 1st of every month.`,
        },
        {
          label: $localize`:@@nav.settings.label:Settings`,
          icon: 'settings',
          route: '/settings',
          tooltip: $localize`:@@nav.settings.tooltip:Theme, silo controls, and app settings`,
        },
        {
          label: $localize`:@@nav.alerts.label:Alerts`,
          icon: 'notifications',
          route: '/alerts',
          tooltip: $localize`:@@nav.alerts.tooltip:Operator alert center`,
        },
        {
          label: $localize`:@@nav.scheduledUpdates.label:Scheduled Updates`,
          icon: 'schedule',
          route: '/scheduled-updates',
          tooltip: $localize`:@@nav.scheduledUpdates.tooltip:Background refresh jobs (11 am – 11 pm serial runner)`,
        },
        {
          label: $localize`:@@nav.crawler.label:Web Crawler`,
          icon: 'travel_explore',
          route: '/crawler',
          tooltip: $localize`:@@nav.crawler.tooltip:Crawl your sites for SEO audit, broken links, and content discovery`,
        },
        {
          label: $localize`:@@nav.errorLog.label:Error Log`,
          icon: 'bug_report',
          route: '/error-log',
          tooltip: $localize`:@@nav.errorLog.tooltip:Background job errors with plain-English explanations`,
        },
        {
          label: $localize`:@@nav.performance.label:Performance`,
          icon: 'speed',
          route: '/performance',
        ...
        // Phase OF — Operations Feed (ambient narration stream).
        {
          ...
          tooltip: $localize`:@@nav.operationsFeed.tooltip:Live commentary of what the system is doing right now`,
        },
        // Phase GB / Gap 149 — User Preference Center.
        {
          label: $localize`:@@nav.preferences.label:Preferences`,
          icon: 'tune',
          route: '/preferences',
          tooltip: $localize`:@@nav.preferences.tooltip:Appearance, language, accessibility, onboarding — all in one place`,
        },
        ...
        {
          label: $localize`:@@nav.models.label:Models`,
          icon: 'developer_board',
          route: '/admin/models',
          tooltip: $localize`:@@nav.models.tooltip:ML model registry — pause, resume, promote, drain, rollback`,
        },
        ...
        {
          label: $localize`:@@nav.undoHistory.label:Undo History`,
          icon: 'restore',
          route: '/audit/undo-timeline',
          tooltip: $localize`:@@nav.undoHistory.tooltip:Recent setting + preset changes you can roll back`,
        },
      ],
    },
  ];
