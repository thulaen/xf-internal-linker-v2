...
describe('SuggestionDetailDialogComponent', () => {
  const detail: SuggestionDetail = {
    ...
    field_aware_diagnostics: {
      ...
      matched_early_main_content: true,
      matched_early_fields: ['title', 'heading'],
      field_scores: {
        title: { score: 0.8, matched_terms: [{ token: 'destination', field_tf: 1, host_tf: 1, field_presence_count: 2, idf: 0.5, token_score: 0.6 }] },
        heading: { score: 0.5, matched_terms: [{ token: 'destination', field_tf: 1, host_tf: 1, field_presence_count: 1, idf: 0.7, token_score: 0.5 }] },
        intro: { score: 0.0, matched_terms: [] },
